...
| `PUT` | `/me/preferencias` | Atualiza preferências (`cobrarFaltas` — consultas FALTA entram na cobrança? — e `duracaoPadraoMinutos` 5–600, default ao criar consulta). Aba Configurações. | `200` · `400` · `401` |
